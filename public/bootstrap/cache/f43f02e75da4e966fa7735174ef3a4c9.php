        ...
        <div class="card">
            ...
            <div class="info-row">
                ...
                <div class="lr-no1">
                    ...
                    Expected Lab Date:-
                    <span class="value">
                        <?php echo e($item->lab_expected_date ? $item->lab_expected_date->format('d/m/Y') : date('d/m/Y')); ?>
...
<?php else: ?>
    ...
    <?php $__currentLoopData = $booking->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="card">
                ...
                <div class="info-row">
                    ...
                    <div class="lr-no1">
                        ...
                        Expected Lab Date:-
                        <span class="value">
                            <?php echo e($it->lab_expected_date ? $it->lab_expected_date->format('d/m/Y') : date('d/m/Y')); ?>
...
<?php /**PATH A:\GenTech\htdocs\GenlabV1.0\GenLabV1.0\resources\views/pdf/booking_cards.blade.php ENDPATH**/ ?>