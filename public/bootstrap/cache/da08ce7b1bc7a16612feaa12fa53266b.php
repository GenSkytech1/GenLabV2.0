<div style="position: relative; padding-top:110px; padding-left:15px; font-family: 'Times New Roman', Times, serif;">
        ...
        <tr>
            ...
            <td style="width:80px; padding-bottom:10px;">
                <?php if(!empty($qr_code_svg)): ?>
                    <img src="<?php echo e($qr_code_svg); ?>" alt="QR Code" style="width:70px; height:70px;">
                <?php endif; ?>
            </td>
    ...
    <?php if(!isset($include_header) || $include_header == 1 ): ?>
        <div align="center" >
                ...
                <tbody>
                    ...
                    <tr style="height: 12px;">
                        ...
                        <td width="283" valign="top" style="width: 282px; padding: 0px 7px; height: 12px;  border: 1px solid black;">
                            <?php echo nl2br(e($letter_ref . ' & ' . \Carbon\Carbon::parse($letter_ref_date)->format('d-m-y'))); ?>
                    ...
                    <tr style="height: 5px;">
                        ...
                        <td width="19" valign="top" style="width: 19px; padding: 0px 7px; height: 5px; border: 1px solid black;">:</td>
                        <td width="539" colspan="4" style="width: 536px; padding: 0px 7px; height: 5px;  border: 1px solid black;"><?php echo nl2br(e($name_of_work)); ?>  <br>
                                <?php echo e("Agency: " . $m_s); ?></td>
                    </tr>
                </tbody>
            </table>  
        </div>
...
<?php /**PATH A:\GenTech\htdocs\GenlabV1.0\GenLabV1.0\resources\views/Reportfrmt/tableHadder.blade.php ENDPATH**/ ?>