...
<body>
    ...
    (function() {
        ...
        var dbPref = <?php echo json_encode(optional($globalSetting)->theme ?? 'system', 15, 512) ?>;
        var dbColor = <?php echo json_encode(optional($globalSetting)->primary_color ?? '#0d6efd', 15, 512) ?>;
    ...
    <script>
(function(){
    var countsUrl = '<?php echo e(url('/chat/unread-counts')); ?>';
