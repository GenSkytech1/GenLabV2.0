...
<div class="row">
    ...
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0">Inventory - Purchase Add Product</h5>
    ...
    <div class="card-body d-flex justify-content-center">
        <form action="#" method="POST" class="w-100" style="max-width: 800px;">
            ...
            <div class="row mb-3">
                <label class="col-lg-3 col-form-label">Bill no*</label>
                <div class="col-lg-9">
                    <input type="text" class="form-control" name="date_of_issue" required>
                </div>
            </div>

            <div class="row mb-3">
                <label class="col-lg-3 col-form-label">Purchase Status *</label>
                <div class="col-lg-9">
                    <select class="form-select" name="sale_to" required>
                        <option value="">Select Star</option>
                        <option value="sirius">Sirius</option>
