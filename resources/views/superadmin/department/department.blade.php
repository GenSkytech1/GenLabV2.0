...
@section('content')
  ...
  <li class="list-inline-item">
    ...
    <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
      <path d="M6 2a2 2 0 0 0-2 2v16c0 1.1.9 2 2 2h12a2 2 0 0 0 2-2V8l-6-6H6zm7 1.5L18.5 9H13V3.5zM8 12h8v2H8v-2zm0 4h5v2H8v-2z"/>
    </svg>
  </a>
  ...
  <a class="p-2 border rounded d-flex align-items-center" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#delete">
    <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
      <path d="M16 14c2.67 0 8 1.34 8 4v2H0v-2c0-2.66 5.33-4 8-4h8zm-8-2a4 4 0 1 1 8 0 4 4 0 0 1-8 0z"/>
    </svg>
  </a>
												</div>
