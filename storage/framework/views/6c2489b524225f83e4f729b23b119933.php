    ...
    <div class="card">
        <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-2">
            ...
            <div class="search-set">
                <form method="GET" action="<?php echo e(route('superadmin.bookingInvoiceStatuses.index', $department?->id)); ?>" class="d-flex input-group">
        ...
        <div class="mb-4 mt-4 ms-3">
            <div class="d-flex flex-wrap gap-2">
                <a href="<?php echo e(route('superadmin.bookingInvoiceStatuses.index')); ?>?search=<?php echo e(request('search')); ?>"
                   class="btn btn-sm <?php echo e(!$department     ? 'btn-primary' : 'btn-outline-primary'); ?>">
                    All
                </a>

                <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('superadmin.bookingInvoiceStatuses.index', $dept->id)); ?>?search=<?php echo e(request('search')); ?>"
...
<?php echo $__env->make('superadmin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\GenLab\resources\views/superadmin/accounts/generateInvoice/index.blade.php ENDPATH**/ ?>